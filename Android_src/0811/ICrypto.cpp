...
struct BpCrypto : public BpInterface<ICrypto> {
    ...
    virtual ssize_t decrypt(
        ...
        ALOGD("1.come in BpCrypto::decrypt(..) 准备进入transact(totalSize=%ld, offset=%ld", totalSize, offset);
        ...
        ALOGD("4.going out BpCrypto::decrypt(..)准备退出BpCrypto return=%ld" , result);
        return result;
    }
...
status_t BnCrypto::onTransact(
    ...
    switch (code) {
        ...
        {
            ALOGD("REQUIRES_SECURE_COMPONENT");
            CHECK_INTERFACE(ICrypto, data, reply);
        ...
        case DECRYPT:
        {   
            ALOGD("DECRYPT before check");
            CHECK_INTERFACE(ICrypto, data, reply);
            ALOGD("DECRYPT after check");
            ...
            ALOGD("2.进入BnCrypto::onTransact(..) local vars (overflow=%d, totalSize=%ld, sumSubsampleSizes=%ld",overflow, totalSize, sumSubsampleSizes);
